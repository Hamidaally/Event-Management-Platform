...
<h3>Welcome EventOrganizer</h3>
    ...
    <form action = "/show" method="post">
      ...
      <button type="button" class="btn btn-primary"><a href="/analytics" style="color: white;">Home Page</a></button>
        ...
        <tr>
          <td> <input type="text" class="form-control" placeholder="Ticket types" name="types"></td> 
        </tr>
        <tr>
          <td> <input type="number" class="form-control" placeholder="Pricing" name="price"></td> 
        </tr>
        <tr>
          <td> <input type="date" class="form-control" placeholder="Date" name="date"></td> 
        </tr>
        <tr>
